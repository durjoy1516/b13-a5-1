...
async function loadIssues(type) {
    ...
    issues.forEach(issue => {
        ...
        let priority = issue.priority === "high" ? "HIGH" : issue.priority === "medium" ? "MEDIUM" : issue.priority === "low" ? "LOW" : issue.priority;
...
async function searchIssue() {
    ...
    data.data.forEach(issue => {
        ...
        let iconBorder = issue.status === "open" ? "border-green-400" : "border-purple-400";
        ...
        <div onclick="openModal(${issue.id})"
            ...
            <div class="p-5">
                <div class="flex justify-between items-center">
                    <div class="w-9 h-9 rounded-full border-2 ${iconBorder} flex items-center justify-center"></div>
